...
sleep 1.34
ros2 topic pub -1 /car std_msgs/msg/String "{data: speed:0.3 distance:1.83 angle:-1 direction:-0.356}"
sleep 6.67
ros2 topic pub -1 /car std_msgs/msg/String "{data: speed:0.3 distance:1.76 angle:-1 direction:-0.5}"
sleep 5.67
